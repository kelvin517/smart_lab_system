  ...
  <section class="section">
    <div class="card shadow-sm border-0">
      <div class="card-body pt-4">
        <h5 class="card-title text-primary">Registered Patients and Test Summaries</h5>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <?= $row['test_names'] ? htmlspecialchars($row['test_names']) : '<span class="text-muted">No Tests Yet</span>' ?>
                </td>
                <td>
                  <?= $row['technician_names'] ? htmlspecialchars($row['technician_names']) : '<span class="text-muted">Pending</span>' ?>
                </td>
                <td>
                ...
                <td>
                  <a href="patient_history.php?id=<?= $row['patient_id'] ?>" class="btn btn-sm btn-primary">
