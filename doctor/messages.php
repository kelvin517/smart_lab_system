      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2" id="messageTabsContent">
              ...
              <div class="tab-pane fade show active" id="inbox" role="tabpanel">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <?php
                    $stmt = $conn->prepare("
                      SELECT ad.full_name AS sender, m.subject, m.body, m.created_at
                      FROM messages m
                      JOIN admins ad ON m.sender_id = ad.id
              ...
              <div class="tab-pane fade" id="outbox" role="tabpanel">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <?php
                    $stmt = $conn->prepare("
                      SELECT p.full_name AS recipient, m.subject, m.body, m.created_at
                      FROM messages m
